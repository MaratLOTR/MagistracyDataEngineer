...
from models import City, WeatherConditions, WeatherForecast

API_KEY = ""  # Замените на ваш ключ
DATABASE_URL = (
    "postgresql://admin:admin@localhost:5432/weather_db"  # Это для примера, можно заменить на вашу базу данных
)
